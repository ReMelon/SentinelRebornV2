...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("purge")
    .setDescription(
      "Purges messages. NOTE : Any messages older than 2 weeks CANNOT be deleted!"
    )
    .addNumberOption((opt) =>
      opt
        .setName("amount")
  ...
  async execute(interaction, client) {
    ...
    const overhundred = new EmbedBuilder()
      ...
      .setColor(`c3b4f7`)
      .setDescription(
        `${backtickred}You cannot delete over 100 messages at a time due to Discord API Limits!\n${backtickredend}`
      )
      .setTimestamp()
      .setFooter({
