...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor(`c3b4f7`)
            .addFields({ name: "`Moderator`", value: `${moderator}`, inline: true }, { name: "`Target`", value: `${target.tag}`, inline: true }, { name: "`Reason`", value: `${reason}`, inline: true }, )
            .setTimestamp()
