...
module.exports = {
    ...
    .addNumberOption((option) => 
		...
		fs.appendFile('cmdl.txt', `[COMMAND USED] GUILD NAME : ${interaction.guild} || TIMESTAMP : ${handleTime(interaction.timestamp)} || INTERACTION_AUTHOR :  ${interaction.user.username + '#' + interaction.user.discriminator} || COMMAND : ${interaction.commandName} || FINAL_TRACKNUM : ${finaltracknum + '\n'}`, (err) => {
			if (err) throw err;    
		  });
